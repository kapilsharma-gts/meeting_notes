...
class ArcPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(lightblueArc, Paint()..color = Colors.lightBlue);
...
List<OnboardingModel> tabs = [
  OnboardingModel(
    'assets/52704-write-handfree.json',
    'Written Your Note',
    'You have handwritten notes to take, \n business memo to share, essay to write,\n have a story to tell, article to edit,\n lecture to record, whether its todays ...',
  ),
  OnboardingModel(
    'assets/78518-girl-doing-remote-job-using-laptop.json',
    'Using Note',
    'a short explanation about how a word or phrase is used The dictionary \nincludes many usage notes. Learn More About usage note. \nShare usage note.',
  ),
  OnboardingModel(
    'assets/29751-social-media-marketing.json',
    'Share',
    'You can share a note with other people so they can edit text,\nShare notes, lists & drawings ,lists, images,\n drawings, and audio recordings. Anyone you share..',
  ),
];
